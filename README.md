...
The narrative explanation generated by AURA directly references relevant lending regulations using Retrieval-Augmented Generation (RAG):

Regulatory Documents Integrated (via RAG):

- Consumer Financial Protection Circular 2022‑03
“Adverse Action Notification Requirements in Connection with Credit Decisions Based on Complex Algorithms” (CFPB)

- Interagency Guidance on Third‑Party Relationships: Risk Management 
Issued jointly by Federal Reserve, FDIC, and OCC
...
“Notification of Action Taken; Statement of Specific Reasons”

- 12 CFR Part 364
“Standards for Safety and Soundness” covering federal banking standards

Semantic Retrieval and Integration:

- Regulatory texts are preprocessed and stored within ChromaDB as semantically searchable chunks.

- During inference, the system automatically retrieves the most relevant regulatory excerpts

- Retrieved regulatory snippets provide direct citations within GPT-4.1 generated narratives.

Compliance Safeguards:

- No protected class information or personally identifiable information (PII) is processed.

- Language strictly adheres to associative rather than causal phrasing (ex: “associated with” instead of “causes”).

- In the event of retrieval downtime, the system gracefully degrades to default narratives that remain compliant and transparent.
...
### Accessing Live Demo
- Hosted App: To instantly view and interact with the deployed version of AURA, visit pranavrao.me. This live version provides all functionality without local installation.
